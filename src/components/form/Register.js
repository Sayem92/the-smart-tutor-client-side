    ...
    return (
        <div className='py-16 px-3 lg:px-52 dark:bg-black'>
            ...
            <form onSubmit={handleSubmit} className='border border-blue-700 dark:border-white rounded-lg p-6'>
                <h2 className='flex justify-center text-3xl text-orange-400 dark:text-white mb-6'>Create an account</h2>
                ...
                <button className="text-white dark:bg-black dark:border  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl w-full sm:w-auto px-5 py-2.5 text-center  dark:focus:ring-blue-800">Create an account</button>
            <p className='mt-2 text-red-600 '>{error}</p>
            </form>
            <div className='px-3 lg:px-64'>
                <div className='dark:text-white py-5 text-center'>
