            ...
            <div className="hero min-h-screen" style={{ backgroundImage: `url("https://i.ibb.co/bJ8K2vL/victoria-heath-MAGAXAYq-NE-unsplash.jpg")` }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md ">
                        <h1 className="mb-5 text-5xl font-bold">Welcome to <span className='text-orange-500 dark:text-white'>The Smart Tutor</span> </h1>
                       ...
                       <Link to='/tutorials'> <button className="btn btn-primary dark:bg-black dark:border-white">Get Started</button></Link>
                    </div>
                </div>
            </div>
        </div>
