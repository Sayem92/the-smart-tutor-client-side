                ...
                <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                    ...
                    <div className="space-y-4">
                        <details className="w-full border dark:border-white border-black rounded-lg">
                            <summary className="px-4 py-6 text-blue-600 dark:text-gray-300 focus:outline-none focus-visible:ring-violet-400">What vlogging means ?</summary>
                        ...
                        <details className="w-full border dark:border-white border-black rounded-lg">
                            <summary className="px-4 py-6 text-blue-600 focus:outline-none dark:text-gray-300 focus-visible:ring-violet-400">What are the 4 types of digital marketing ?</summary>
                        ...
                        <details className="w-full border dark:border-white border-black rounded-lg">
                            <summary className="px-4 py-6 dark:text-gray-300 text-blue-600 focus:outline-none focus-visible:ring-violet-400">What is the importance of health and fitness ? </summary>
                            <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-300 text-gray-900">
                        ...
                        <details className="w-full border dark:border-white border-black rounded-lg">
                            <summary className="px-4 py-6 text-blue-600 focus:outline-none dark:text-gray-300 focus-visible:ring-violet-400">   What is the purpose of gaming ? </summary>
                            <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-300 text-gray-900">
                        ...
                        <details className="w-full border dark:border-white border-black rounded-lg">
                            <summary className="px-4 py-6 text-blue-600 focus:outline-none dark:text-gray-300 focus-visible:ring-violet-400"> Who is a fashion make up artist ? </summary>
                            <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-300 text-gray-900">
